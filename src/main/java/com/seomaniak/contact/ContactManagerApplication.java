...
public class ContactManagerApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        // Seed seulement si la table est vide → fonctionne en local H2 ET sur Railway
		String activeProfile = System.getenv("RAILWAY_ENVIRONMENT");
		if (activeProfile == null || "development".equals(activeProfile)) {
			if (repository.count() == 0) {
				...
				System.out.println("8 contacts insérés (seed)");
			}
		}
    }
}
